...
const Footer: React.FC = () => {
  return (
    <footer className="h-screen py-12">
      ...
      {/* Footer Bottom Text */}
      <div className="flex flex-col justify-center lg:flex-row lg:justify-between lg:items-end text-xs text-center text-gray-400 space-y-2 px-20">
